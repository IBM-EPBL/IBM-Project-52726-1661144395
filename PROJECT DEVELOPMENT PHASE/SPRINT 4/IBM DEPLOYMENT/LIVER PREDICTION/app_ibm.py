...
def result():
   ...
   # NOTE: manually define and pass the array(s) of values to be scored in the next line
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/5d0706b5-2994-4b84-b6bb-c6505650b81a/predictions?version=2022-11-1', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
    ...
    if predict==1:
        ...
        return render_template('neg.html',confidence=confidence)
